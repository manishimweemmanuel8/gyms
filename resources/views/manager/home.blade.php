                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="box-model">
                            ...
                            <div class="newstick">
                                <div class="recent">
                                    <div class="row">
                                        <img src="{{asset('asset/admin/img/admin/user1.png')}}" class="recent-user-img" alt="image not found">
                                        <h5>
                               ...
                               25 / 08 / 2016</span></small>
                                    ...
                                    <div class="row bg-default">
                                        <img src="{{asset('asset/admin/img/admin/user2.png')}}" class="recent-user-img" alt="image not found">
                                        <h5>
                                        <a href="{{asset('asset/admin/admin_userprofile.html')}}" class="text-primary">Barbara A. Egan </a>
                                    </h5>
                                        <small>Aerobics<span class="pull-right">
                                23 / 08 / 2016</span></small>
                                    </div>
                                    <div class="row">
                                        <img src="{{asset('asset/admin/img/admin/user3.png')}}" class="recent-user-img" alt="image not found">
                                        <h5>
                                 ...
                                 19 / 08 / 2016</span></small>
                                    ...
                                    <div class="row bg-default">
                                        <img src="{{asset('asset/admin/img/admin/user4.png')}}" class="recent-user-img" alt="image not found">
                                        <h5>
                                ...
                                15 / 08 / 2016</span></small>
                                    ...
                                    <div class="row">
                                        <img src="{{asset('asset/admin/img/admin/user5.png')}}" class="recent-user-img" alt="image not found">
                                        <h5>
                                ...
                                <div class="box-model event">
                                    ...
                                    <div class="events_hover">
                                        <a href="event_item.html">
                                            <div class="row">
                                                <img src="{{asset('asset/admin/img/admin/event1.png')}}" class="recent-user-img" alt="image not found">
                                        ...
                                        <a href="event_item.html">
                                            <div class="row">
                                                <img src="{{asset('asset/admin/img/admin/event2.png')}}" class="recent-user-img" alt="image not found">
                                        ...
                                        <a href="event_item.html">
                                            <div class="row">
                                                <img src="{{asset('asset/admin/img/admin/event3.png')}}" class="recent-user-img" alt="image not found">
                                                <h5> 5k Marthon </h5>
                                        ...
                                        <a href="event_item.html">
                                            <div class="row">
                                                <img src="{{asset('asset/admin/img/admin/event4.png')}}" class="recent-user-img" alt="image not found">
                                        ...
                                        <a href="event_item.html">
                                            <div class="row">
                                                <img src="{{asset('asset/admin/img/admin/event5.png')}}" class="recent-user-img" alt="image not found">
