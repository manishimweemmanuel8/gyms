    ...
    <div class="container">
        <div class="full-content-center">
            <div class="box bounceInLeft animated">
                ...
                <form class="form" id="log_in" method="POST" action="<?php echo e(route('receptionist.login')); ?>" aria-label="<?php echo e(__('Login')); ?>">
                ...
                <p class="text-right">
                     <a class="text-warning forgot_color" href="<?php echo e(route('receptionist.password.request')); ?>">
...
<?php /**PATH /Volumes/Mac OS emm/job/etouch/Project/gms/resources/views/receptionist/auth/login.blade.php ENDPATH**/ ?>