...
<head>
    ...
    <!-- Bootstrap CSS
        ============================================ -->
    <link rel="stylesheet" href="<?php echo e(asset('asset/web/css/bootstrap.min.css')); ?>">
    <!-- Font Awesome CSS
        ============================================ -->
    <link rel="stylesheet" href="<?php echo e(asset('asset/web/css/font-awesome.min.css')); ?>">
    <!-- Owl Caousel CSS 
        ============================================ -->
    <link rel="stylesheet" href="<?php echo e(asset('asset/web/vendor/OwlCarousel/owl.carousel.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('asset/web/vendor/OwlCarousel/owl.theme.default.min.css')); ?>">
    <!-- meanmenu CSS
        ============================================ -->
    <link rel="stylesheet" href="<?php echo e(asset('asset/web/css/meanmenu.min.css')); ?>">
    <!-- normalize CSS
        ============================================ -->
    <link rel="stylesheet" href="<?php echo e(asset('asset/web/css/normalize.css')); ?>">
    <!-- main CSS
        ============================================ -->
    <link rel="stylesheet" href="<?php echo e(asset('asset/web/css/main.css')); ?>">
    <!-- nivo slider CSS
        ============================================ -->
    <link rel="stylesheet" href="<?php echo e(asset('asset/web/css/custom-slider/css/nivo-slider.css')); ?>" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(asset('asset/web/css/custom-slider/css/preview.css')); ?>" type="text/css" media="screen" />
    <!-- flaticon CSS
        ============================================ -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('asset/web/css/flaticon.css')); ?>">
    <!-- Wow CSS
        ============================================ -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('asset/web/css/animate.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('asset/web/css/site.css')); ?>">
    <!-- Switch Style CSS 
        ============================================ -->
    <link rel="stylesheet" href="<?php echo e(asset('asset/web/css/hover-min.css')); ?>">
    <!-- Magic popup CSS 
        ============================================-->
    <link rel="stylesheet" href="<?php echo e(asset('asset/web/css/magnific-popup.css')); ?>">
    <!-- style CSS
        ============================================ -->
    <link rel="stylesheet" href="<?php echo e(asset('asset/web/style.css')); ?>">
    <!-- responsive CSS
        ============================================ -->
    <link rel="stylesheet" href="<?php echo e(asset('asset/web/css/responsive.css')); ?>">
    <!-- modernizr JS
        ============================================ -->
    <script src="<?php echo e(asset('asset/web/js/vendor/modernizr-2.8.3.min.js')); ?>"></script>
</head>
...
<body>
    ...
    <div class="wrapper">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-2 col-md-2 col-sm-2">
                            <div class="logo-area">
                                <a href=""><img src="<?php echo e(asset('asset/web/img/logo.png')); ?>" alt="logo"></a>
                            </div>
                        </div>
                            ...
                            <div class="main-menu">
                                <nav>
                                    <ul id="nav">
                                        ...
                                        <li> <a class="nav-link" href="<?php echo e(route('receptionist.login')); ?>"><?php echo e(__('Login')); ?></a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                                                ...
                                                <div class="cart-single-product">
                                                    <div class="media">
                                                        <div class="pull-left cart-product-img">
                                                            <a href="#">
                                                                <img class="media-object" src="<?php echo e(asset('asset/web/img/product/cart-img.png')); ?>" alt="product">
                                                            </a>
                                                        </div>
        ...
        <div class="slider-area slider-top-space-header1 slider1-caption">
            <div class="bend niceties preview-2">
                <div id="ensign-nivoslider" class="slides">
                    <img src="<?php echo e(asset('asset/web/img/slides/slide1.jpg')); ?>" alt="image" title="#slider-direction-1" />
                    <img src="<?php echo e(asset('asset/web/img/slides/slide2.jpg')); ?>" alt="image" title="#slider-direction-1" />
                    <img src="<?php echo e(asset('asset/web/img/slides/slide1.jpg')); ?>" alt="image" title="#slider-direction-1" />
                </div>
                <!-- direction 1 -->
            ...
            <div class="container-fluid">
                <div class="about-fitness-left">
                    <div class="about-left-img padding-space">
                        <img src="<?php echo e(asset('asset/web/img/about-fitness-img.png')); ?>" alt="about-fitness-img">
                        <div class="overly">
                ...
                <div class="gym-carousel nav-control-top" data-loop="true" data-items="3" data-margin="15" data-autoplay="false" data-autoplay-timeout="10000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-r-x-small="1" data-r-x-small-nav="true" data-r-x-small-dots="false" data-r-x-medium="2" data-r-x-medium-nav="true" data-r-x-medium-dots="false" data-r-small="2" data-r-small-nav="true" data-r-small-dots="false" data-r-medium="3" data-r-medium-nav="true" data-r-medium-dots="false" data-r-large="3" data-r-large-nav="true" data-r-large-dots="false">
                    <div class="single-product-classes">
                        <div class="single-product">
                            <a href="#"><img class="img-responsive" src="<?php echo e(asset('asset/web/img/feature1.jpg')); ?>" alt="product"></a>
                            <div class="overly">
                                <ul>
                                    <li>16 Dec</li>
                                    <li>06.AM</li>
                    ...
                    <div class="single-product-classes">
                        <div class="single-product">
                            <a href="#"><img class="img-responsive" src="<?php echo e(asset('asset/web/img/feature2.jpg')); ?>" alt="product"></a>
                            <div class="overly">
                                <ul>
                                    <li>16 Dec</li>
                                    <li>06.AM</li>
                    ...
                    <div class="single-product-classes">
                        <div class="single-product">
                            <a href="#"><img class="img-responsive" src="<?php echo e(asset('asset/web/img/feature3.jpg')); ?>" alt="product"></a>
                            <div class="overly">
                                <ul>
                                    <li>16 Dec</li>
                                    <li>06.AM</li>
                    ...
                    <div class="single-product-classes">
                        <div class="single-product">
                            <a href="#"><img class="img-responsive" src="<?php echo e(asset('asset/web/img/feature4.jpg')); ?>" alt="product"></a>
                            <div class="overly">
                                <ul>
                                    <li>16 Dec</li>
                                    <li>06.AM</li>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="being-left-img">
                            <img src="<?php echo e(asset('asset/web/img/being-builder.png')); ?>" alt="being-builder">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div class="gym-carousel dot-control" data-loop="true" data-items="2" data-margin="15" data-autoplay="false" data-autoplay-timeout="10000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-r-x-small="1" data-r-x-small-nav="false" data-r-x-small-dots="true" data-r-x-medium="1" data-r-x-medium-nav="false" data-r-x-medium-dots="true" data-r-small="2" data-r-small-nav="false" data-r-small-dots="true" data-r-medium="2" data-r-medium-nav="false" data-r-medium-dots="true" data-r-large="2" data-r-large-nav="false" data-r-large-dots="true">
                            <div class="single-client-say">
                                <div class="pull-left client-picture">
                                    <img src="<?php echo e(asset('asset/web/img/client1.jpg')); ?>" alt="client1">
                                </div>
                            ...
                            <div class="single-client-say">
                                <div class="pull-left client-picture">
                                    <img src="<?php echo e(asset('asset/web/img/client2.jpg')); ?>" alt="client2">
                                </div>
                                <div class="media-body client-content">
            ...
            <div class="container">
                <div class="gym-carousel nav-control-top" data-loop="true" data-items="3" data-margin="15" data-autoplay="false" data-autoplay-timeout="10000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-r-x-small="1" data-r-x-small-nav="true" data-r-x-small-dots="false" data-r-x-medium="1" data-r-x-medium-nav="true" data-r-x-medium-dots="false" data-r-small="2" data-r-small-nav="true" data-r-small-dots="false" data-r-medium="3" data-r-medium-nav="true" data-r-medium-dots="false" data-r-large="3" data-r-large-nav="true" data-r-large-dots="false">
                    <div class="single-trainer-item">
                        <div class="trainer-item">
                            <div class="trainer-img">
                                <img src="<?php echo e(asset('asset/web/img/trainers/trainer1.jpg')); ?>" alt="trainer1">
                    ...
                    <div class="single-trainer-item">
                        <div class="trainer-item">
                            <div class="trainer-img">
                                <img src="<?php echo e(asset('asset/web/img/trainers/trainer2.jpg')); ?>" alt="trainer2">
                                <div class="social-overly">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                        <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                    ...
                    <div class="single-trainer-item">
                        <div class="trainer-item">
                            <div class="trainer-img">
                                <img src="<?php echo e(asset('asset/web/img/trainers/trainer3.jpg')); ?>" alt="trainer3">
                                <div class="social-overly">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                        <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                    ...
                    <div class="single-trainer-item">
                        <div class="trainer-item">
                            <div class="trainer-img">
                                <img src="<?php echo e(asset('asset/web/img/trainers/trainer4.jpg')); ?>" alt="trainer4">
                                <div class="social-overly">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                        <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                ...
                <div class="row portfolioContainer gallery-wrapper zoom-gallery">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 Yoga Gym">
                        <div class="gallery-box">
                            <img src="<?php echo e(asset('asset/web/img/gallery/1.jpg')); ?>" class="img-responsive" alt="gallery">
                            <div class="gallery-content">
                                <a href="<?php echo e(asset('asset/web/img/gallery/1.jpg')); ?>" class="elv-zoom" title="Fitness"><i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 Running Gym Fitness">
                        <div class="gallery-box">
                            <img src="<?php echo e(asset('asset/web/img/gallery/2.jpg')); ?>" class="img-responsive" alt="gallery">
                            <div class="gallery-content">
                                <a href="<?php echo e(asset('asset/web/img/gallery/2.jpg')); ?>" class="elv-zoom" title="Push Up"><i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 Yoga Running Fitness">
                        <div class="gallery-box">
                            <img src="<?php echo e(asset('asset/web/img/gallery/3.jpg')); ?>" class="img-responsive" alt="gallery">
                            <div class="gallery-content">
                                <a href="<?php echo e(asset('asset/web/img/gallery/3.jpg')); ?>" class="elv-zoom" title="Weight Lifting"><i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 Yoga Gym">
                        <div class="gallery-box">
                            <img src="<?php echo e(asset('asset/web/img/gallery/4.jpg')); ?>" class="img-responsive" alt="gallery">
                            <div class="gallery-content">
                                <a href="<?php echo e(asset('asset/web/img/gallery/4.jpg')); ?>" class="elv-zoom" title="Free Hand"><i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 room Gym Fitness">
                        <div class="gallery-box">
                            <img src="<?php echo e(asset('asset/web/img/gallery/5.jpg')); ?>" class="img-responsive" alt="gallery">
                            <div class="gallery-content">
                                <a href="<?php echo e(asset('asset/web/img/gallery/5.jpg')); ?>" class="elv-zoom" title="Body Building"><i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 Yoga campus">
                        <div class="gallery-box">
                            <img src="<?php echo e(asset('asset/web/img/gallery/6.jpg')); ?>" class="img-responsive" alt="gallery">
                            <div class="gallery-content">
                                <a href="<?php echo e(asset('asset/web/img/gallery/6.jpg')); ?>" class="elv-zoom" title="Gym"><i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="gym-carousel nav-control-top nav-on-hover" data-loop="true" data-items="4" data-margin="15" data-autoplay="false" data-autoplay-timeout="10000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-r-x-small="1" data-r-x-small-nav="true" data-r-x-small-dots="false" data-r-x-medium="2" data-r-x-medium-nav="true" data-r-x-medium-dots="false" data-r-small="2" data-r-small-nav="true" data-r-small-dots="false" data-r-medium="3" data-r-medium-nav="true" data-r-medium-dots="false" data-r-large="4" data-r-large-nav="true" data-r-large-dots="false">
                    <div class="single-product-store">
                        <div class="single-product">
                            <a href="#"><img src="<?php echo e(asset('asset/web/img/product/product1.png')); ?>" alt="product"></a>
                    ...
                    <div class="single-product-store">
                        <div class="single-product">
                            <a href="#"><img src="<?php echo e(asset('asset/web/img/product/product2.png')); ?>" alt="product"></a>
                            <div class="overlay"></div>
                            <div class="product-info">
                                <ul>
                                    <li><a href="#" title="Cart"><i class="fa fa-shopping-cart"></i></a></li>
                    ...
                    <div class="single-product-store">
                        <div class="single-product">
                            <a href="#"><img src="<?php echo e(asset('asset/web/img/product/product3.png')); ?>" alt="product"></a>
                            <div class="overlay"></div>
                            <div class="product-info">
                                <ul>
                                    <li><a href="#" title="Cart"><i class="fa fa-shopping-cart"></i></a></li>
                    ...
                    <div class="single-product-store">
                        <div class="single-product">
                            <a href="#"><img src="<?php echo e(asset('asset/web/img/product/product4.png')); ?>" alt="product"></a>
                            <div class="overlay"></div>
                            <div class="product-info">
                                <ul>
                                    <li><a href="#" title="Cart"><i class="fa fa-shopping-cart"></i></a></li>
        ...
        <div class="counter-area" style="background-image: url('<?php echo e(asset('asset/web/img/banner/counter-back.jpg')); ?>');">
            <div class="container">
                <div class="row">
                ...
                <div class="gym-carousel nav-control-top" data-loop="true" data-items="3" data-margin="30" data-autoplay="false" data-autoplay-timeout="10000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-r-x-small="1" data-r-x-small-nav="true" data-r-x-small-dots="false" data-r-x-medium="1" data-r-x-medium-nav="true" data-r-x-medium-dots="false" data-r-small="2" data-r-small-nav="true" data-r-small-dots="false" data-r-medium="3" data-r-medium-nav="true" data-r-medium-dots="false" data-r-large="3" data-r-large-nav="true" data-r-large-dots="false">
                    <div class="single-latest-news">
                        <div class="single-news">
                            <div class="single-image"><img src="<?php echo e(asset('asset/web/img/news1.jpg')); ?>" alt="news1"></div>
                            <div class="date">20
                                <br>Jan
                                <br>2016</div>
                        </div>
                    ...
                    <div class="single-latest-news">
                        <div class="single-news">
                            <div class="single-image"><img src="<?php echo e(asset('asset/web/img/news2.jpg')); ?>" alt="news2"></div>
                            <div class="date">20
                                <br>Jan
                                <br>2016</div>
                        </div>
                    ...
                    <div class="single-latest-news">
                        <div class="single-news">
                            <div class="single-image"><img src="<?php echo e(asset('asset/web/img/news3.jpg')); ?>" alt="news3"></div>
                            <div class="date">20
                                <br>Jan
                                <br>2016</div>
                        </div>
                ...
                <div class="gym-carousel nav-control-middle-opacity" data-loop="true" data-items="6" data-margin="30" data-autoplay="false" data-autoplay-timeout="10000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-r-x-small="2" data-r-x-small-nav="true" data-r-x-small-dots="false" data-r-x-medium="3" data-r-x-medium-nav="true" data-r-x-medium-dots="false" data-r-small="4" data-r-small-nav="true" data-r-small-dots="false" data-r-medium="5" data-r-medium-nav="true" data-r-medium-dots="false" data-r-large="6" data-r-large-nav="true" data-r-large-dots="false">
                    <div class="single-logo-area">
                        <div class="single-logo">
                            <a href="#"><img src="<?php echo e(asset('asset/web/img/client/1.jpg')); ?>" alt="client1"></a>
                        </div>
                    </div>
                    <div class="single-logo-area">
                        <div class="single-logo">
                            <a href="#"><img src="<?php echo e(asset('asset/web/img/client/2.jpg')); ?>" alt="client2"></a>
                        </div>
                    </div>
                    <div class="single-logo-area">
                        <div class="single-logo">
                            <a href="#"><img src="<?php echo e(asset('asset/web/img/client/3.jpg')); ?>" alt="client3"></a>
                        </div>
                    </div>
                    <div class="single-logo-area">
                        <div class="single-logo">
                            <a href="#"><img src="<?php echo e(asset('asset/web/img/client/4.jpg')); ?>" alt="client4"></a>
                        </div>
                    </div>
                    <div class="single-logo-area">
                        <div class="single-logo">
                            <a href="#"><img src="i<?php echo e(asset('asset/web/mg/client/5.jpg')); ?>" alt="client5"></a>
                        </div>
                    </div>
                    <div class="single-logo-area">
                        <div class="single-logo">
                            <a href="#"><img src="<?php echo e(asset('asset/web/img/client/6.jpg')); ?>" alt="client6"></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6">
                            <div class="flickr-photos">
                                ...
                                <div class="flickr-list">
                                    <ul>
                                        <li>
                                            <a class="fancybox" href="<?php echo e(asset('asset/web/img/flickr/flickr1.png')); ?>" data-fancybox-group="flickr" title="flickr1"><img src="<?php echo e(asset('asset/web/img/flickr/flickr1.png')); ?>" alt="flickr1"></a>
                                        </li>
                                        <li>
                                            <a class="fancybox" href="<?php echo e(asset('asset/web/img/flickr/flickr2.png')); ?>" data-fancybox-group="flickr" title="flickr2"><img src="<?php echo e(asset('asset/web/img/flickr/flickr2.png')); ?>" alt="flickr2"></a>
                                        </li>
                                        <li>
                                            <a class="fancybox" href="<?php echo e(asset('asset/web/img/flickr/flickr3.png')); ?>" data-fancybox-group="flickr" title="flickr3"><img src="<?php echo e(asset('asset/web/img/flickr/flickr3.png')); ?>" alt="flickr3"></a>
                                        </li>
                                        <li>
                                            <a class="fancybox" href="<?php echo e(asset('asset/web/img/flickr/flickr4.png')); ?>" data-fancybox-group="flickr" title="flickr4"><img src="<?php echo e(asset('asset/web/img/flickr/flickr4.png')); ?>" alt="flickr4"></a>
                                        </li>
                                        <li>
                                            <a class="fancybox" href="<?php echo e(asset('asset/web/img/flickr/flickr5.png')); ?>" data-fancybox-group="flickr" title="flickr5"><img src="<?php echo e(asset('asset/web/img/flickr/flickr5.png')); ?>" alt="flickr5"></a>
                                        </li>
                                        <li>
                                            <a class="fancybox" href="<?php echo e(asset('asset/web/img/flickr/flickr6.png')); ?>" data-fancybox-group="flickr" title="flickr6"><img src="<?php echo e(asset('asset/web/img/flickr/flickr6.png')); ?>" alt="flickr6"></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3">
                            <div class="visa-card">
                                <ul>
                                    <li>
                                        <a href="#"><img src="<?php echo e(asset('asset/web/img/visa-card.png')); ?>" alt="visa-card"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="<?php echo e(asset('asset/web/img/descover.png')); ?>" alt="descover"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="<?php echo e(asset('asset/web/img/paypal.png')); ?>" alt="paypal"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="<?php echo e(asset('asset/web/img/card.png')); ?>" alt="card"></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <!-- jquery
        ============================================ -->
    <script src="<?php echo e(asset('asset/web/js/vendor/jquery-1.11.3.min.js')); ?>"></script>
    <!-- bootstrap JS
        ============================================ -->
    <script src="<?php echo e(asset('asset/web/js/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('asset/web/js/bootstrap-tabcollapse.js')); ?>"></script>
    <!-- meanmenu JS
        ============================================ -->
    <script src="<?php echo e(asset('asset/web/js/jquery.meanmenu.min.js')); ?>"></script>
    <!-- Owl Cauosel JS 
        ============================================ -->
    <script src="<?php echo e(asset('asset/web/vendor/OwlCarousel/owl.carousel.min.js')); ?>" type="text/javascript"></script>
    <!-- Nivo slider js
        ============================================ -->
    <script src="<?php echo e(asset('asset/web/css/custom-slider/js/jquery.nivo.slider.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('asset/web/css/custom-slider/home.js')); ?>" type="text/javascript"></script>
    <!-- Zoom JS
        ============================================ -->
    <script src="<?php echo e(asset('asset/web/js/jquery.zoom.js')); ?>"></script>
    <!-- Isotope JS
        ============================================ -->
    <script src="<?php echo e(asset('asset/web/js/isotope.pkgd.js')); ?>"></script>
    <!-- One Page menu action JS
        ============================================ -->
    <script src="<?php echo e(asset('asset/web/js/jquery.nav.js')); ?>"></script>
    <!-- Counter Up JS
        ============================================ -->
    <script src="<?php echo e(asset('asset/web/js/waypoints.min.js')); ?>"></script>
    <script src="<?php echo e(asset('asset/web/js/jquery.counterup.min.js')); ?>"></script>
    <!-- Magic Popup js 
        ============================================-->
    <script src="<?php echo e(asset('asset/web/js/jquery.magnific-popup.min.js" type="text/javascript')); ?>"></script>
    <!-- Wow JS
        ============================================ -->
    <script src="<?php echo e(asset('asset/web/js/wow.min.js')); ?>"></script>
    <!-- plugins JS
        ============================================ -->
    <script src="<?php echo e(asset('asset/web/js/plugins.js')); ?>"></script>
    <!-- Google Map js -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBgREM8KO8hjfbOC0R_btBhQsEQsnpzFGQ"></script>
    <!-- Validator js 
        ============================================ -->
    <script src="<?php echo e(asset('asset/web/js/validator.min.js')); ?>" type="text/javascript"></script>
    <!-- main JS
        ============================================ -->
    <script src="<?php echo e(asset('asset/web/js/main.js')); ?>"></script>
</body>
...
<?php /**PATH /Volumes/Mac OS emm/job/etouch/Project/gms/resources/views/welcome.blade.php ENDPATH**/ ?>