                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="box-model">
                            ...
                            <div class="newstick">
                                <div class="recent">
                                    <div class="row">
                                        <img src="<?php echo e(asset('asset/admin/img/admin/user1.png')); ?>" class="recent-user-img" alt="image not found">
                                        <h5>
                                        <a href="" class="text-primary">Adam B. Engles </a>
                                    </h5>
                                        <small>Yoga<span class="pull-right">
                               25 / 08 / 2016</span></small>
                                    </div>
                                    <div class="row bg-default">
                                        <img src="<?php echo e(asset('asset/admin/img/admin/user2.png')); ?>" class="recent-user-img" alt="image not found">
                                        <h5>
                                        <a href="<?php echo e(asset('asset/admin/admin_userprofile.html')); ?>" class="text-primary">Barbara A. Egan </a>
                                    </h5>
                                        <small>Aerobics<span class="pull-right">
                                23 / 08 / 2016</span></small>
                                    </div>
                                    <div class="row">
                                        <img src="<?php echo e(asset('asset/admin/img/admin/user3.png')); ?>" class="recent-user-img" alt="image not found">
                                        <h5>
                                        <a href="" class="text-primary">Caroline G. Turner </a>
                                    </h5>
                                        <small>Power Yoga<span class="pull-right">
                                 19 / 08 / 2016</span></small>
                                    </div>
                                    <div class="row bg-default">
                                        <img src="<?php echo e(asset('asset/admin/img/admin/user4.png')); ?>" class="recent-user-img" alt="image not found">
                                        <h5>
                                        <a href="" class="text-primary">Kevin S. McCabe </a>
                                    </h5>
                                        <small>Fitness<span class="pull-right">
                                15 / 08 / 2016</span></small>
                                    </div>
                                    <div class="row">
                                        <img src="<?php echo e(asset('asset/admin/img/admin/user5.png')); ?>" class="recent-user-img" alt="image not found">
                                        <h5>
                                        <a href="" class="text-primary">Richard S. Jensen </a>
                                    </h5>
                                        <small>Fitness<span class="pull-right">
                                15 / 08 / 2016</span></small>
                                    </div>
                                ...
                                <div class="box-model event">
                                    ...
                                    <div class="events_hover">
                                        <a href="event_item.html">
                                            <div class="row">
                                                <img src="<?php echo e(asset('asset/admin/img/admin/event1.png')); ?>" class="recent-user-img" alt="image not found">
                                        ...
                                        <a href="event_item.html">
                                            <div class="row">
                                                <img src="<?php echo e(asset('asset/admin/img/admin/event2.png')); ?>" class="recent-user-img" alt="image not found">
                                        ...
                                        <a href="event_item.html">
                                            <div class="row">
                                                <img src="<?php echo e(asset('asset/admin/img/admin/event3.png')); ?>" class="recent-user-img" alt="image not found">
                                                <h5> 5k Marthon </h5>
                                        ...
                                        <a href="event_item.html">
                                            <div class="row">
                                                <img src="<?php echo e(asset('asset/admin/img/admin/event4.png')); ?>" class="recent-user-img" alt="image not found">
                                        ...
                                        <a href="event_item.html">
                                            <div class="row">
                                                <img src="<?php echo e(asset('asset/admin/img/admin/event5.png')); ?>" class="recent-user-img" alt="image not found">
...
<?php echo $__env->make('receptionist.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Mac OS emm/job/etouch/Project/gms/resources/views/receptionist/home.blade.php ENDPATH**/ ?>